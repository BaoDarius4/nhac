module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
      ...
      if(message.member.voice.selfDeaf) return message.channel.send(`:x: **Bạn không thể nào sài bot khi đang tắt âm**`);
      ...
      return message.channel.send(`**:boom: Xóa... :stop_button:**`);
  }
};
/**
 * @INFO
